...
public class _LightProbeLab_7 : MonoBehaviour {
	...
	void Start () {
        ...
        factor = 1.0f;
        m_BaseCoefficients = new float[LightmapSettings.lightProbes.bakedProbes.Length];
        Array.Copy(LightmapSettings.lightProbes.bakedProbes, m_BaseCoefficients, LightmapSettings.lightProbes.bakedProbes.Length);

        m_Coefficients = new float[LightmapSettings.lightProbes.bakedProbes.Length];
	}
	...
	void Update () {
        ...
        Array.Copy(LightmapSettings.lightProbes.bakedProbes, m_Coefficients, LightmapSettings.lightProbes.bakedProbes.Length);
    }
    void OnGUI()
    {
        GUI.skin = skin;
